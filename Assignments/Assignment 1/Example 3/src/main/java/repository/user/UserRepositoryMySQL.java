...
//            PreparedStatement insertUserStatement2 = connection
//                    .prepareStatement("INSERT INTO user_role values (null, ?, ?)", Statement.RETURN_GENERATED_KEYS);
//            insertUserStatement2.setInt(1, user.getId());
//            insertUserStatement2.setInt(2, 2);
//            System.out.println("Adasda");
//            insertUserStatement2.executeUpdate();
//
//            ResultSet rss = insertUserStatement.getGeneratedKeys();
//            rss.next();
