...
public class EmployeeView extends JFrame{
    ...
    private void initializeFields() {
        ...
        amountTxt = new JTextField("balance");
        ...
        Connection connection = new JDBConnectionWrapper("bank").getConnection();
    ...
    public void setAmountTxt(String balance) {
